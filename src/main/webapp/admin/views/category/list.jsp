...
<a href="<%=request.getContextPath()%>/admin/categories/create" class="btn btn-primary me-2">Add
    New</a>
...
<div class="table-responsive pt-3">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="/admin/categories/update?id=<%= category.getId() %>">Edit</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/admin/categories/delete?id=<%= category.getId() %>" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
