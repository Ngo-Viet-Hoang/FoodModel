                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<%=request.getContextPath()%>/admin/foods/create" class="btn btn-primary me-2">Add
                                    New </a>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <%= food.getId() %></td>
                                            <td>
                                                <img width="200"  src="<%= food.getThumbnail() %>" />
                                            </td>
                                            <td><%= food.getName() %></td>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="/admin/foods/update?id=<%= food.getId() %>">Edit</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="/admin/foods/delete?id=<%= food.getId() %>" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
